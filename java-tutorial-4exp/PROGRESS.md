...
| 10 | SQL | 10 | SQL | 10 | SQL | 10 | SQL | 10 | SQL | 10 | SQL & NoSQL | `10-sql-nosql/README.md` | `core-java-examples/.../database/` | ❌ TODO | 🟡 Medium | NoSQL | `10-sql-nosql/README.md` | `database/` | ✅ DONE | NoSQL | `10-sql-nosql/README.md` | `database/` | ✅ DONE | NoSQL | `10-sql-nosql/README.md` | `database/` | ✅ DONE | NoSQL | `10-sql-nosql/README.md` | `database/` | ✅ DONE | NoSQL | `10-sql-nosql/README.md` | `database/` | ✅ DONE |
