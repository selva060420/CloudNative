...
public class RestApiPatternsDemo {
    ...
    public static void main(String[] args) {
        ...
        var created = handlePost(Map.of("name", "Laptop", "price", 999.99));
        ...
        handlePost(Map.of("name", "Mouse", "price", 29.99));
        handlePost(Map.of("name", "Keyboard", "price", 79.99));

        // 2. GET — Read (200 OK)
        System.out.println("\n--- GET /products/1 (Read) ---");
        var getResult = handleGet(1L);
        ...
        var error = handlePost(Map.of("name", "", "price", -5.0));
    ...
    static Map<String, Object> handlePost(Map<String, Object> body) {
        // Validation
    ...
    static Map<String, Object> handleGet(Long id) {
